...
int main() {
  try {
    ...
    // [啟動功能備註｜HTTP API] 註冊核心 C++ 路由、v39 相容 API 與條件式規則引擎。
    service->registerRoutes();
    // [啟動功能備註｜世界自動化] 啟動離線 AI 與元素自生背景結算。
    trpg::startWorldAutomation(service);
    ...
    drogon::app().setClientMaxBodySize(32U * 1024U * 1024U);
