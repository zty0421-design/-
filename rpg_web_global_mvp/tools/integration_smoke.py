...
def run(args: argparse.Namespace) -> None:
    ...
    require(version_info.get("version") == "60-cpp.21.2", "unexpected server version")
    ...
    require(status.get("version") == "60-cpp.21.2", "unexpected C++ version")
    ...
    passed("character fields, allocation, BIGINT and derived stats")
    ...
    # 60-cpp.21.2: wheel schema/API must work on the same fresh PostgreSQL used by room creation.
