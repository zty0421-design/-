...
def main():
    required=[
        ...
        'db/legacy_v39_migrations.sql','tests/security_test.cpp','tools/integration_smoke.py','docs/VERSION.txt','docs/api_parity.json','docs/FEATURE_MAP.md','docs/RULE_ENGINE_GUIDE.md','docs/SKILL_SYSTEM_OVERVIEW.md','docs/RITUAL_SYSTEM_OVERVIEW.md','docs/MAGIC_SYSTEM_OVERVIEW.md'
    ]
    ...
    expect(version=='65-cpp.26.4' and 'kVersion = "65-cpp.26.4"' in read('include/trpg/CoreService.h') and 'C++ 相容版 65-cpp.26.4' in read('public/index.html') and '"version": "65-cpp.26.4"' in read('docs/api_parity.json'),
           '65-cpp.26.4 版本資訊一致','版本資訊不同步')
    expect('v65-cpp-26-4-multi-portrait-combat-ui' in read('public/sw.js'),'Service Worker 快取版本已更新','Service Worker 仍使用舊快取')
    ...
    expect(smoke.find('def passed(name: str)') < smoke.find('passed("PWA version endpoint")') and 'status.get("version") == "65-cpp.26.4"' in smoke,
    ...
    expect('version_info.get("version") == "65-cpp.26.4"' in smoke and
