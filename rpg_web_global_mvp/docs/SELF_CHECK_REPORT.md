...
- PostgreSQL portal parameter $3 startup hotfix: default equipment-slot seed now uses parameter-free trusted literal SQL to avoid Drogon/libpq binary-width ambiguity.
- Release checker now rejects the old parameterized startup seed pattern.
